<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Skills.aspx.cs" Inherits="CV_Project.Skills" %>
			...
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div class="collapse">
					<ul>
						...
						<li><a href="Services.aspx" data-nav-section="services">Services</a></li>
						<li class="active"><a href="#" data-nav-section="skills">Skills</a></li>
						<li><a href="Education.aspx" data-nav-section="education">Education</a></li>
						<li><a href="Experiene.aspx" data-nav-section="experience">Experience</a></li>
				...
				<div class="colorlib-narrow-content">
					...
					<div class="row">
						<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
							<p>Most of the skills I have, I learned from my personal projects because learning is unlimited when you are learning by yourself</p>
						</div>
